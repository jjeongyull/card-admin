  ...
  >
    <el-scrollbar class="no-x-scroll">
      <div class="modal-body">
        ...
        <el-form label-position="top">
          <!-- 컴플라이언스명 -->
          <el-form-item label="컴플라이언스명">
            <el-input v-model="form.complianceName" placeholder="컴플라이언스명을 입력해주세요." />
          </el-form-item>
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button @click="submitForm" class="black-button">추가완료</el-button>
      </div>
    </template>
  </el-dialog>
</template>
