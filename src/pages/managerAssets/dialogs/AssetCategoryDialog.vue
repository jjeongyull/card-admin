<template>
  <el-dialog
    ...
    :title="updataData?'자산 카테고리 수정':'자산 카테고리 등록'"
    :width="dialogWidth"
    ...
    <el-scrollbar class="no-x-scroll">
      <div class="modal-body">
        <el-form label-position="top">
          ...
          <!-- 분류명 -->
          <el-form-item class="mb-20" label="분류명">
            <el-input v-model="form.name" placeholder="분류명을 입력해주세요." />
          </el-form-item>
    ...
    <template #footer>
      <div class="dialog-footer" :class="{ 'flex-space': updataData }">
        ...
        <div class="footer-right">
          ...
          <BaseButton @click="submitForm" class="black-button">자산 카테고리 등록</BaseButton>
        </div>
