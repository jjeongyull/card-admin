    ...
    <el-scrollbar class="no-x-scroll">
      <div class="modal-body">
        ...
        <el-form label-position="top">
          ...
          <el-form-item class="mb-20" label="자산유형">
            <el-radio-group v-model="status">
              <el-radio label="서버">서버</el-radio>
              <el-radio label="데이터 베이스">데이터 베이스</el-radio>
              <el-radio label="네트워크">네트워크</el-radio>
              <el-radio label="보안장비">보안장비</el-radio>
              <el-radio label="WEB / WAS">WEB / WAS</el-radio>
              <el-radio label="전문">전문</el-radio>
...
// 반응형 다이얼로그 크기 설정
const dialogWidth = ref(window.innerWidth < 1000 ? "90vw" : "1000px");
const updateDialogWidth = () => {
  dialogWidth.value = window.innerWidth < 1000 ? "90vw" : "1000px";
};
